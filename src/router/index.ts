...
const init_cf=async(to, from, next) => {
       let c=await import('@/store/modules/cf.ts');
       await c.CfModule.List()
       next();
}
...
const  Cf=()=>import('@/components/cf/cf')
  ...
  routes: [
    ...
    { path: '/admin',name:"admin", component: Admin, meta: { requiresAuth: true ,title:"控制面板"},
      children: [
          ...
          { path: 'cf', name: 'cf',component:Cf, beforeEnter:init_cf},
      ]
    },
    ...
    { path: '/order/:id', name: 'order_s', component: Order,meta: { requiresAuth: false,title:"下单成功"},},
    { path: '/orders/:id', name: 'order_c',component:Order1, meta: { requiresAuth: false,title:"订单详情"}, beforeEnter: init_order, },
    { path: '/products1', name: 'products_c', component:Products1, meta: { requiresAuth: false,title:"商品列表"}, beforeEnter:init_products } ,
    { path: '/products/:id',name: 'product_c', component:AddProduct, meta: { requiresAuth: true ,title:"商品详情"}, beforeEnter:init_product } ,
  ]
})
